...
<head>
  ...
  <title>@yield('title','Online EShop') - {{setting('app_name')}}</title>
            ...
            <div class="col-lg-7 pr-0">
              <ul class="nav navbar-nav center_nav pull-right">
                <li class="nav-item {{Request::path() === '/' ? 'active' : ''}}">
                  <a class="nav-link" href="{{route('home')}}"style="font-size: large;">Home</a>
                </li>

                <li class="nav-item {{Request::path() === 'shop' ? 'active' : ''}}">
                  <a class="nav-link" href="{{route('shop')}}" style="font-size: large;">Shop</a>
                </li>

                <li class="nav-item {{Request::path() === 'post' ? 'active' : ''}}">
                  <a class="nav-link" href="{{route('post')}}" style="font-size: large;">Blog</a>
                </li>

                <li class="nav-item {{Request::path() === 'contact' ? 'active' : ''}}">
                  <a class="nav-link" href="{{route('contact')}}" style="font-size: large;">Contact</a>
                </li>
...
<footer class="footer-area section_gap">
  <div class="container">
    ...
    <div class="footer-bottom row align-items-center">
      <p class="footer-text m-0 col-lg-8 col-md-12">@if( Helper::setting()->has('copyright_text') && !empty(setting('copyright_text')) ) {{setting('copyright_text')}} | @endif Online <a href="{{ route('home') }}" target="_blank">EShop</a></p>
